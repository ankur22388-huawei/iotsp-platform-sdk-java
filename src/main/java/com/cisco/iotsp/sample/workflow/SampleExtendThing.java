...
public class SampleExtendThing {
	...
	public boolean mergeThing(String accountAlias) {
		try {
			...
			String thingDefFilePath = "src/main/resources/file/sampleThingMerge.json";
			String newSchemaFilePath = "src/main/resources/file/sampleSchemaLocation.json";

			//Create schema, that defines the syntax of device's new properties
			ObjectMapper mapper = new ObjectMapper();			
			SchemaCreateRequest schemaRequest = mapper.readValue(new File(newSchemaFilePath), SchemaCreateRequest.class);
			...
			String input = JsonHelper.loadFileToString(thingDefFilePath);
			String locSchemaUidTag = String.format("\"schemaUid\": \"%s\"", newSchemaUid);
			input = input.replace("\"schemaUid\": \"locationSchemaUid\"", locSchemaUidTag);
	...
	public boolean updateThing(String accountAlias) {
		try {
			String devManufacturingId = "a151c893-c7bc-48d6-8494-7e7775dcf3e5";
			String thingDefFilePath = "src/main/resources/file/sampleThingUpdate.json";
			String newSchemaFilePath = "src/main/resources/file/sampleSchemaLocation.json";
			...
			ThingUpdateRequest thingUpdateRequest = mapper.readValue(new File(thingDefFilePath), ThingUpdateRequest.class);
